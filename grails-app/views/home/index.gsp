...
<div class="form-group">
    <h1>To-Do <small>List</small>
        <a href="completed" class="btn btn btn-primary">Completed Task</a>
    </h1>
    ...
    <table class="table table-striped">
        <g:each in="${tasksList}" var="show">
            ...
            <g:if test="${show.dateCompleted==null}">
                <td>${show.content} </td>
                <td>
                    <g:link controller="home" action="markCompleted" class="btn btn btn-primary" id="${show.id}">Done</g:link>
            </g:if>
            </tr>
        </g:each>
    </table>
